...
Canvas support is available in the **GitHub Copilot app** (the primary surface) and in **GitHub Copilot CLI** *(v1.0.71+)*, where canvases render inline in the terminal session.
...
In the GitHub Copilot app or Copilot CLI *(v1.0.71+)*, create canvases from an active session using the `/create-canvas` skill.
