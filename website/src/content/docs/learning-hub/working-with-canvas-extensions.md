...
> **New in v1.0.71**: Canvas support is now also available in the GitHub Copilot CLI. You can use canvas extensions for extension-driven interactive surfaces directly from the CLI terminal, not just from the Copilot app.
