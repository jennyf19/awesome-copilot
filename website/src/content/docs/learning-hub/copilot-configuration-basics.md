...
| `defaultMode` | Default session mode for new interactive sessions — `"plan"`, `"interactive"`, or `"autopilot"` (v1.0.79+) |
| `defaultPermissionMode` | Default approval behavior for new interactive sessions — controls how tool-use permission prompts are handled (v1.0.81+) |
