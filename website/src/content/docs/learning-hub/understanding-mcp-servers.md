...
- Blocked servers appear as **blocked** in `/mcp` *(v1.0.81+)* — rather than spinning indefinitely as pending — making it immediately clear which servers are policy-restricted.
