...
Yes, as of v1.0.72. **Multi-turn subagents are always enabled**, meaning you can send follow-up messages to a subagent while it is still running — no configuration required. This makes it easier to redirect or clarify mid-task without waiting for the subagent to finish.
