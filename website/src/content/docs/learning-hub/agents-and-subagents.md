...
- **multi-turn subagents are always enabled** (v1.0.72+): you can send follow-up messages to a running subagent without waiting for it to finish — useful for providing mid-task corrections or clarifications
