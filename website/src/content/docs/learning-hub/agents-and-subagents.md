...
Yes. Multi-turn subagents are always enabled — you can send additional messages to a subagent that is still running. This allows you to redirect, clarify, or add context to an in-progress delegated task without waiting for it to complete first.
